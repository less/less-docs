...
Crunch 2 is a cross-platform (Windows, Mac, and Linux) editor with integrated Less compiling, debugging, and @import searching. If you work with large Less projects, you should definitely try it out, as you only need the free version for Less files. Available at: [http://getcrunch.co/](http://getcrunch.co/).
