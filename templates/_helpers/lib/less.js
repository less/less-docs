...
module.exports = function(hljs) {
  ...
  VALUE.push( 
    ...
    IDENT_MODE('variable', '@{'  + IDENT_RE + '}'), // this is here only to color it in stuff like :nth-child(@{var}), but anyway...
  ...
  var SELECTOR_MODE = {
    ...
    contains: [
      hljs.C_LINE_COMMENT_MODE,
      hljs.C_BLOCK_COMMENT_MODE, // btw. probably we can fix /* { */ issue by turning this into regex only mode - test
      MIXIN_GUARD_MODE,
      ...
      IDENT_MODE('keyword',  '&', 0), // todo: merge this with 'all' above?
